  ...
  describe Seniors do
    ...
    describe "enough data" do
      before(:each) do
        ...
        @list = "2011-09-01"
        @p1 = FactoryGirl.create(:icu_player, dob: "1950-08-02", gender: "F")
        @p2 = FactoryGirl.create(:icu_player, dob: "1940-08-01")
        @p3 = FactoryGirl.create(:icu_player, dob: "1960-01-01")
        @p4 = FactoryGirl.create(:icu_player, dob: "1970-05-31")
        @p5 = FactoryGirl.create(:icu_player, dob: "1940-06-01", fed: "RUS")
