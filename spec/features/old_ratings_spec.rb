...
describe "OldRating" do
  describe "listing" do
    before(:each) do
      login("reporter")
      FactoryBot.create(:icu_player, id: 1350, first_name: "Mark", last_name: "Orr")
      FactoryBot.create(:icu_player, id: 1349, first_name: "John", last_name: "Orr")
      FactoryBot.create(:icu_player, id: 10349, first_name: "Aoife", last_name: "Bannon")
      FactoryBot.create(:old_rating, rating: 2198, games: 329, icu_id: 1350)
      FactoryBot.create(:old_rating, rating: 1349, games: 51, icu_id: 1349)
      FactoryBot.create(:old_rating, rating: -58, games: 4, full: false, icu_id: 10349)
