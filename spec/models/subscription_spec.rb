...
describe Subscription do
  context "#season" do
    it "should convert a date to the current season" do
      ...
      expect(Subscription.season(Time.new(2012,9,1))).to eq("2011-12")
  ...
  context "#last_season" do
    it "should convert a date to the last season" do
      ...
      expect(Subscription.last_season(Time.new(2012,9,1))).to eq("2010-11")
      expect(Subscription.last_season(Time.new(2012,9,31))).to eq("2010-11")
      expect(Subscription.last_season(Time.new(2012,10,1))).to eq("2010-11")
