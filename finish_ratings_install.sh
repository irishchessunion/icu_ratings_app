...
echo "Finishing install of ratings site with version $1 and GIT_HASH of $2"
...
echo "Branch master (at $2) deployed as release $1 by `whoami`" >> /var/apps/ratings/revisions.log
